...
public class Server {
	...
	public static void main(String[] args) {
		...
		options.addOption("s",true,"secret to connect to other server with");
		options.addOption("ms",true,"This servers secret");
		...
		if(cmd.hasOption("ms")){
			Settings.setMySecret(cmd.getOptionValue("ms"));
		}
		...
		final Control replica = Control.getInstance();
